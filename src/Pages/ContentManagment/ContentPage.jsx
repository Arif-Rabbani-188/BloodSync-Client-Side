...
const ContentPage = () => {
  ...
  useEffect(() => {
    axios
      .get("https://blood-sync-server-side.vercel.app/blogs")
  ...
  <div className="p-6 w-full md:w-10/12 mx-auto mt-20 md:mt-0">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {filteredBlogs.map((blog) => (
          <div
            key={blog._id}
            className="flex flex-col justify-between border rounded shadow p-4 bg-white"
          >
            <img
              src={blog.thumbnail}
              alt="Thumbnail"
            ...
            <p className="text-sm text-gray-500">
              Author Mail: {blog.authorEmail || "Unknown"}
            </p>
