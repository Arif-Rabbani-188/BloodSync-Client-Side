...
const districts = ['Dhaka', 'Chittagong', 'Khulna', 'Rajshahi'];
const upazilas = {
            ...
            <form onSubmit={handleSearch} className="flex flex-col gap-4 mb-8">
                ...
                <div>
                    ...
                    <select
                        ...
                        className={`w-full px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-400 ${!form.district ? 'bg-gray-100 cursor-not-allowed' : 'bg-white'}`}
                    >
                ...
                <div>
                    {filtered.length === 0 ? (
                        ...
                        <ul className="space-y-4">
                            {filtered.map((donor) => (
                                <li key={donor.id} className="bg-gray-100 p-4 rounded-lg shadow flex flex-col gap-1">
                                    <span>
                                    ...
                                    <span>
                                        <span className="font-semibold">Location:</span> {donor.district}, {donor.upazila}
                                    </span>
                                </li>
                            ))}
                        </ul>
